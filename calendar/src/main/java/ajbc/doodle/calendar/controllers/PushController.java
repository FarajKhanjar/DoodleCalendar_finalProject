...
////		users.forEach(u -> {if(u.userOnline()==true) {
////			byte[] result;
////			try {
////				result = this.cryptoService.encrypt("fffff",
...
////		try {
////
////			sendPushMessageToAllSubscribers(this.subscriptions, new PushMessage("message: ", "ff"));
...
//
//		users.forEach(u -> {if(u.userOnline==1) {
//			byte[] result;
//			try {
